  ...
  return (
    <section className="relative min-h-[95svh] md:min-h-screen flex items-end sm:items-center justify-center overflow-hidden pt-16 sm:pt-20 md:pt-0 pb-20 sm:pb-20 md:pb-0">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-8 text-left w-full md:mt-16">
        ...
        >
          <h1 className="font-display text-[1.12rem] xs:text-[1.25rem] tracking-tighter whitespace-nowrap sm:whitespace-normal sm:text-4xl md:text-6xl lg:text-7xl font-black leading-snug sm:leading-tight mb-1 md:mb-4 text-white" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.8), 0 0 40px rgba(0,0,0,0.6)' }}>
