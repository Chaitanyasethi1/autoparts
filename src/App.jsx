  ...
  return (
    <section className="relative min-h-[95svh] md:min-h-screen flex items-end sm:items-center justify-center overflow-hidden pt-16 sm:pt-20 md:pt-0 pb-20 sm:pb-20 md:pb-0 bg-zinc-950">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-8 text-left w-full md:mt-32 md:pt-6">
        ...
        >
          <h1 className="font-display text-[0.95rem] xs:text-[1.15rem] tracking-normal sm:tracking-tighter whitespace-nowrap sm:whitespace-normal sm:text-4xl md:text-5xl lg:text-6xl font-black leading-snug sm:leading-tight mb-0 md:mb-4 text-white pt-16 sm:pt-0" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.8), 0 0 40px rgba(0,0,0,0.6)' }}>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-4 font-body text-xs text-muted-foreground">
          ...
          <p className="text-center whitespace-nowrap">
            Developed By <span className="text-foreground font-semibold">ABS (Aggarwal Business Solutions)</span>
          </p>
